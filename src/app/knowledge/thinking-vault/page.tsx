...
export const THINKING_VAULT_TALK_URL = "/talks/thinking-vault/";
export const THINKING_VAULT_REPO_URL =
  "https://github.com/CarryLewis/research_brief";

export const metadata: Metadata = {
  title: "Thinking Vault",
  description:
    "HTML talk from Research Brief — Notion as input, Obsidian as memory/graph.",
};

export default function ThinkingVaultPage() {
  return (
    <section className="flex min-h-[calc(100vh-4rem)] flex-col bg-void">
      <div className="flex flex-wrap items-center justify-between gap-lab-3 border-b border-rule bg-surface-raised px-margin py-lab-3">
        <p className="font-sans text-label uppercase text-ink-tertiary">
          ...
          {" / Thinking Vault · in iteration"}
        </p>
        <div className="flex flex-wrap gap-lab-4">
          <a
            href={THINKING_VAULT_TALK_URL}
      ...
      <iframe
        title="Thinking Vault talk"
        src={THINKING_VAULT_TALK_URL}
        className="w-full flex-1 border-0 bg-void"
